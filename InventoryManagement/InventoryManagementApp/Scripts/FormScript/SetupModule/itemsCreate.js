...
$(document.body).on("click", "#btnSubmit", function () {
    ...
    vm.unitId = $("#UnitId").val();
    vm.itemsName = $("#ItemsName").val();
    vm.purchasePrice = $("#PurchasePrice").val();
    vm.salePrice = $("#SalePrice").val();
    vm.reoderLevel = $("#ReoderLevel").val();
...
function getData(id) {
    $.get("/api/Items?id=" + id)
        .done(function (data) {
            ...
            $("#ReoderLevel").val(data.reoderLevel);
